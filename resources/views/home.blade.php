        ...
        <div class="relative isolate">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-32">
                <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                    <div
                        class="relative rounded-full px-3 py-1 text-sm/6 text-gray-500 ring-1 ring-white/10 hover:ring-white/20">
                ...
                <div class="text-center">
                    <h1 class="text-5xl font-semibold tracking-tight text-gray-800  sm:text-7xl">Connecting Top Talent With Ambitious Companies</h1>
